...
===========================
# Important
There is no release of OnStepX yet but it has basic testing done now and all features are implemented so I consider it ready for testing by advanced OnStep users.
